        ...
        (async function() {
          try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
              ...
              body: JSON.stringify({
                websiteId: 'dd249553-58ee-45a4-a117-3927a50babf5',
                name: data.name || data.fullName || data.fullname || '',
                email: data.email || '',
                subject: data.subject || 'Contact Form Submission',
                message: data.message || data.msg || data.comments || '',
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "The cringe משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
